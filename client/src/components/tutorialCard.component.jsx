...
export default class TutorialCard extends Component {
        ...
        this.state = {
            ...
            cardsInfo: [
                ...
                },
                {
                    ...
                    img: "https://proxy.duckduckgo.com/iu/?u=https%3A%2F%2Fi.ytimg.com%2Fvi%2FQZjAuRdB5Qk%2Fhqdefault.jpg&f=1&nofb=1"
    ...
    nextCard = (e)=>{
        e.preventDefault();
        if (this.state.iterator < this.state.cardsInfo.length-1) {
            this.setState({iterator:+1})
            this.forceUpdate();
        }else{
        ...
        return (
            <div className="card animated slideInUp">
                ...
                <div className="view overlay">
                    <img className="card-img-top" src={cardsInfo[iterator].img} alt="header pic" />
                    <a href="#!">
                ...
                <button className="btn btn-success mt-5 w-50
